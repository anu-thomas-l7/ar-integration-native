    ...
    <View style={styles.menu}>
      <View style={styles.menuTop}>
        <View
          ...
          source={{
            uri: 'https://litmus7.wpenginepowered.com/wp-content/uploads/2022/05/Litmus7-logo-01-e1653634863997.png',
          }}
          /> */}
          ...
          {/* <Text style={{...styles.headerText, fontSize: 24}}>Litmus7</Text> */}
        </View>
      </View>
